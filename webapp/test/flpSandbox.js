		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#sapktfragmentfragment-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapktfragmentfragment-display": {
								"semanticObject": "sapktfragmentfragment",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.kt.fragment.fragment",
									"url": sap.ui.require.toUrl("sap/kt/fragment/fragment")
								}
							}
						}
					}
